...
public class ContainerIntegrationTable extends ContainerBCTile<TileIntegrationTable> {
    public ContainerIntegrationTable(int windowId, Inventory playerInv, TileIntegrationTable tile) {
        super(BCSiliconRegistries.INTEGRATION_TABLE_MENU.get(), windowId, tile);
    ...
    public ContainerIntegrationTable(int windowId, Inventory playerInv, FriendlyByteBuf extraData) {
