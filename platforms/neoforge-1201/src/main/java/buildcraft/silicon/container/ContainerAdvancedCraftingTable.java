...
public class ContainerAdvancedCraftingTable extends ContainerBCTile<TileAdvancedCraftingTable> {
    public ContainerAdvancedCraftingTable(int windowId, Inventory playerInv, TileAdvancedCraftingTable tile) {
        super(BCSiliconRegistries.ADVANCED_CRAFTING_TABLE_MENU.get(), windowId, tile);
    ...
    public ContainerAdvancedCraftingTable(int windowId, Inventory playerInv, FriendlyByteBuf extraData) {
