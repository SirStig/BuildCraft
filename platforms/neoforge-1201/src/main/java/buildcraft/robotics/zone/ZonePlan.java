 ...
 * block coordinates. Ported near-verbatim from 1.12.2's class of the same name -- see the 26.x copy of this class
 * for the full account of the {@code PacketBuffer} scope cut.
 */
