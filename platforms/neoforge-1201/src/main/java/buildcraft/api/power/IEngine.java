 ...
 * engines without using {@code receivePower()}, which has other issues.
 */
public interface IEngine {
    /** @return True if the engine wants to receive power from another engine on this side. */
     ...
     * @param simulate If true then just pretend you received power -- don't actually change any internal state.
