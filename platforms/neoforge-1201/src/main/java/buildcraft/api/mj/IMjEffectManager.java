 ...
 * entities. Identical to the 26.x version -- the vanilla types involved did not change between 1.20.1 and 26.x -- but
 * kept per-platform so the two MJ api packages stay self-contained. */
