 ...
 *
 * <p>Every NBT/buffer method here takes a {@link HolderLookup.Provider}, following {@code StatementType}'s own
...
public class FullStatement<S extends IStatement> implements IReference<S> {
    ...
    public void readFromNbt(CompoundTag nbt, HolderLookup.Provider registries) {
        statement = type.readFromNbt(nbt.getCompound("s"), registries);
        if (statement == null) {
