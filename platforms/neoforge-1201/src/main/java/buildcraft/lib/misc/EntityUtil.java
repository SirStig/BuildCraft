...
public class EntityUtil {
    public static NonNullList<ItemStack> collectItems(Level world, BlockPos around, double radius) {
        // Vec3 has no Vec3i constructor on this target (unlike 26.x), so the conversion is spelled out.
        Vec3 center = new Vec3(around.getX(), around.getY(), around.getZ());
        return collectItems(world, center.add(0.5, 0.5, 0.5), radius);
    }
