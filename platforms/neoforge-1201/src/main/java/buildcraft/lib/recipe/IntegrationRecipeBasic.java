...
public class IntegrationRecipeBasic extends IntegrationRecipe {
    ...
    public IntegrationRecipeBasic(ResourceLocation name, long requiredMicroJoules, IngredientStack target, List<IngredientStack> toIntegrate, @NotNull ItemStack output) {
        super(name);
