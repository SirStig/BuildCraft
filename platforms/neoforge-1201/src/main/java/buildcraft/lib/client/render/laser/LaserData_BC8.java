 ...
 * {@link ResourceLocation} are both common classes), so a {@link LaserType} constant can be declared from common code
 * without dragging client classes onto a dedicated server.
 *
 * <p><b>Changed from 1.12.2</b>, all deliberate:
 * <ul>
 * <li>{@link LaserRow#sprite} is a block-atlas sprite {@link ResourceLocation}, not a {@code SpriteHolderRegistry}
...
public class LaserData_BC8 {
    ...
    public static class LaserType {
        ...
        public LaserType(LaserType from, ResourceLocation replacementSprite) {
    ...
    public static class LaserRow {
        ...
        public LaserRow(ResourceLocation sprite, int uMin, int vMin, int uMax, int vMax, int textureSize, LaserSide... sides) {
            this.sprite = sprite;
        ...
        public LaserRow(ResourceLocation sprite, int uMin, int vMin, int uMax, int vMax, LaserSide... sides) {
            this(sprite, uMin, vMin, uMax, vMax, 16, sides);
        }

        public LaserRow(LaserRow from, ResourceLocation sprite) {
            this.sprite = sprite;
            this.uMin = from.uMin;
            this.vMin = from.vMin;
            this.uMax = from.uMax;
