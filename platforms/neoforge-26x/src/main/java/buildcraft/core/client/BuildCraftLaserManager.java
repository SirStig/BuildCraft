...
public final class BuildCraftLaserManager {
    ...
    public static final Identifier SPRITE_MARKER_VOLUME_POSSIBLE = sprite("marker_volume_possible");
    public static final Identifier SPRITE_MARKER_VOLUME_SIGNAL = sprite("marker_volume_signal");
    public static final Identifier SPRITE_MARKER_PATH_CONNECTED = sprite("marker_path_connected");
    public static final Identifier SPRITE_MARKER_PATH_POSSIBLE = sprite("marker_path_possible");
    public static final Identifier SPRITE_MARKER_DEFAULT_POSSIBLE = sprite("marker_default_possible");
    public static final Identifier SPRITE_STRIPES_READ = sprite("stripes_read");
    public static final Identifier SPRITE_STRIPES_WRITE = sprite("stripes_write");
    public static final Identifier SPRITE_STRIPES_WRITE_DIRECTION = sprite("stripes_write_direction");
    public static final Identifier SPRITE_POWER_LOW = sprite("power_low");
    ...
    static {
        {
            Identifier sprite = SPRITE_MARKER_VOLUME_CONNECTED;
        ...
        {
            Identifier sprite = SPRITE_MARKER_PATH_CONNECTED;
        ...
        {
            Identifier sprite = SPRITE_MARKER_VOLUME_POSSIBLE;
