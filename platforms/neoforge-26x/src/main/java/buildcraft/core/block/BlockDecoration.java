 ...
 * subtyping is gone (PORTING.md's structural-changes list, item 1), so this becomes six real blocks, one per
 * variant, the same way {@link BlockSpringWater} splits 1.12.2's {@code BlockSpring}.
 *
