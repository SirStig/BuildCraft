 ...
 * {@link OilSpringGenerator} instance and its {@code PlacedFeature}/biome-modifier wrapper are pure datapack JSON
 * instead, under {@code data/buildcraft/worldgen/feature/spring_oil.json} and friends).
 */
