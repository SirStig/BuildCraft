...
/** Ported from 1.12.2's {@code GuiIntegrationTable}: background plus the same laser-power progress bar as
 * {@code GuiAssemblyTable}/{@code GuiAdvancedCraftingTable}. */
public class GuiIntegrationTable extends AbstractContainerScreen<ContainerIntegrationTable> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("buildcraft", "textures/gui/integration_table.png");
