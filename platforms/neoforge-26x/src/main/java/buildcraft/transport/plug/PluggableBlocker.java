...
/**
 * Port of 1.12.2's {@code buildcraft.transport.plug.PluggableBlocker} -- the simplest pluggable, a plain plug
 * that blocks a pipe face with no other behaviour. {@code getModelRenderKey}/advancement-unlocking are dropped:
 * the former belongs to the rendering rewrite (see {@link PipePluggable}'s own javadoc for why it has no
 * equivalent here yet), and the latter is cosmetic and out of this batch's scope.
 */
