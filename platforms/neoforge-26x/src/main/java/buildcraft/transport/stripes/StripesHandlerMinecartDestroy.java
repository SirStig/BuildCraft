 ...
 * {@code setDead()} is {@link AbstractMinecart#discard()}. {@link AbstractMinecartContainer} is a plain
 * {@link net.minecraft.world.Container} here, so slots are read/cleared through that interface directly rather
 * than 1.12.2's own {@code IInventory}. */
