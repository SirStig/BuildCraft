...
/** Returns true if the stack matches any one one of the filter stacks. Checks item tags (the ore dictionary's
 * replacement -- see {@link StackUtil#isCraftingEquivalent}) and wildcards. */
