...
public final class CompiledLaser {
    ...
    static final class Builder {
        ...
        private final Function<Identifier, TextureAtlasSprite> sprites;
        ...
        Builder(LaserData_BC8 data, @Nullable Level level, Function<Identifier, TextureAtlasSprite> sprites) {
            this.data = data;
            this.level = level;
        ...
        private int computeLight(double x, double y, double z) {
            ...
            if (level == null) {
                return LightCoordsUtil.pack(Math.max(0, data.minBlockLight), 15);
            }
            ...
            int packed = LightCoordsUtil.pack(block, sky);
