 ...
 * {@code ICapabilityProvider}, {@link LogicalSide} for {@code Side}, {@link RegistryFriendlyByteBuf} for
...
public abstract class PipePluggable {
     ...
     */
    public void writeCreationPayload(RegistryFriendlyByteBuf buffer) {
    }
    ...
    @Nullable
    public <T> T getInternalCapability(BlockCapability<T, Direction> cap) {
        return null;
    }
