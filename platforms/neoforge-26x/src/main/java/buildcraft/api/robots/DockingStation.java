...
public abstract class DockingStation {
    ...
    public void readFromNBT(CompoundTag nbt) {
        if (nbt.contains("index")) {
            ...
            CompoundTag indexNBT = nbt.getCompound("index").orElseGet(CompoundTag::new);
            int x = indexNBT.getIntOr("i", 0);
            int y = indexNBT.getIntOr("j", 0);
            int z = indexNBT.getIntOr("k", 0);
        ...
        side = Direction.values()[nbt.getByteOr("side", (byte) 0)];
        linkIsMain = nbt.getBooleanOr("isMain", false);
        robotTakingId = nbt.getLongOr("robotId", 0L);
    }
