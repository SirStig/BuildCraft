...
/**
 * Which sprites a pipe draws on one face, and what colour each is tinted.
 *
 * <p>Pure Java -- the sprite indices are BuildCraft's own, resolved to real sprites by the renderer -- so this
 * lives in {@code :shared} rather than being duplicated per platform. Nothing in it needed porting.
 */
